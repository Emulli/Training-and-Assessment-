...
<body class="bg-neutral-bg text-gray-700 flex flex-col min-h-screen">
    ...
    <nav class="bg-white shadow-lg sticky top-0 z-40 border-b border-gray-100" x-data="{ mobileMenuOpen: false }">
                ...
                <div class="relative" x-data="{ open: false }" @click.away="open = false" @mouseleave="open = false">
                    ...
                    >
                        ...
                        <div class="px-2 pb-2 mb-2 border-b border-gray-100">
                            <a href="/partners" class="block px-4 py-2 text-xs font-bold text-primary uppercase tracking-wider bg-violet-50 rounded-lg hover:bg-violet-100 transition-colors">
                        ...
                        >
                            ...
                            <div 
                                ...
                                class="absolute left-full top-0 ml-1 w-56 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden"
                                style="display: none;"
                            >
                                <div class="bg-gray-50 px-4 py-2 border-b border-gray-100">
                                    <span class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Quick Links</span>
                                </div>
                                <a href="/partners/tech-solutions/about" class="block px-4 py-2 text-sm text-gray-600 hover:text-primary hover:bg-gray-50">About Company</a>
                                <a href="/partners/tech-solutions/hiring" class="block px-4 py-2 text-sm text-gray-600 hover:text-primary hover:bg-gray-50 flex justify-between items-center">
                                    Job Openings 
                                </a>
                                <a href="/partners/tech-solutions/ojt" class="block px-4 py-2 text-sm text-gray-600 hover:text-primary hover:bg-gray-50">OJT Program</a>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            >
                                ...
                                <a href="#" class="block px-4 py-2 text-sm text-gray-600 hover:text-primary hover:bg-gray-50">Profile</a>
                                <a href="#" class="block px-4 py-2 text-sm text-gray-600 hover:text-primary hover:bg-gray-50">Requirements</a>
                            </div>
                        </div>
        ...
        <div x-show="mobileMenuOpen" class="md:hidden bg-white border-t border-gray-100 p-4 space-y-2">
             ...
             <a href="/OJT/index.php?tab=training#about-us" class="block py-2 text-gray-600 hover:text-primary">About Us</a>
             ...
             <a href="/partners" class="block py-2 text-gray-600 hover:text-primary">Companies</a>
        </div>
    </nav>