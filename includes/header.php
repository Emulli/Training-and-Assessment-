    ...
    <nav class="bg-white shadow-lg sticky top-0 z-40 border-b border-gray-100" x-data="{ mobileMenuOpen: false }">
            ...
            <div class="hidden md:flex items-center gap-8 font-semibold text-gray-600 text-sm tracking-wide">
                ...
                <div class="relative" x-data="{ open: false }" @click.away="open = false" @mouseleave="open = false">
                    ...
                    >
                        ...
                        <div class="px-2 pb-2 mb-2 border-b border-gray-100">
                            <a href="/OJT/index.php?tab=training#popular-programs" class="block px-4 py-2 text-xs font-bold text-primary uppercase tracking-wider bg-violet-50 rounded-lg hover:bg-violet-100 transition-colors">
                                View All Programs &rarr;
                            </a>
                        </div>

                        <div class="px-2 space-y-1">
                            <a href="/training/bookkeeping.php" class="block w-full px-4 py-2 text-sm text-gray-600 rounded-lg hover:text-primary hover:bg-gray-50 transition-colors">
                                Bookkeeping
                            </a>
                            <a href="/training/hardware-servicing.php" class="block w-full px-4 py-2 text-sm text-gray-600 rounded-lg hover:text-primary hover:bg-gray-50 transition-colors">
                                Computer Hardware Servicing
                            </a>
                             <a href="/training/security.php" class="block w-full px-4 py-2 text-sm text-gray-600 rounded-lg hover:text-primary hover:bg-gray-50 transition-colors">
                                Security Services
                            </a>
                        </div>
                ...
                <div class="relative" x-data="{ open: false }" @click.away="open = false" @mouseleave="open = false">
                    ...
                    >
                        ...
                        <div class="px-2 pb-2 mb-2 border-b border-gray-100">
                            <a href="/OJT/index.php?tab=#partners" class="block px-4 py-2 text-xs font-bold text-primary uppercase tracking-wider bg-violet-50 rounded-lg hover:bg-violet-100 transition-colors">
                        ...
                        >
                            <button 
                                ...
                                class="w-full flex items-center justify-between px-4 py-2 text-sm text-gray-600 rounded-lg hover:text-primary hover:bg-gray-50 transition-colors text-left"
                            >
                                ETB Industrial Facilities Construction
                            </button>
                        </div>
        ...
        <div x-show="mobileMenuOpen" class="md:hidden bg-white border-t border-gray-100 p-4 space-y-2">
             ...
             <div class="py-2 border-t border-b border-gray-50 my-2">
                <span class="text-xs font-bold text-gray-400 uppercase tracking-wider pl-2">Training Programs</span>
                <a href="/training/bookkeeping.php" class="block py-2 pl-4 text-gray-600 hover:text-primary">Bookkeeping</a>
                <a href="/training/hardware-servicing.php" class="block py-2 pl-4 text-gray-600 hover:text-primary">Hardware Servicing</a>
