...
// --- 2. FETCH PARTNERS FROM DATABASE ---
...
// --- 3. FETCH LATEST COURSES FROM DATABASE ---
$sql_courses = "SELECT * FROM courses ORDER BY created_at DESC LIMIT 3";
        ...
        <div class="flex items-center gap-3">
            <?php if (isset($_SESSION['user_id'])): ?>
                <div class="hidden md:flex flex-col items-end mr-2">
                    <span class="text-xs text-gray-300 uppercase tracking-widest">Welcome back</span>
                    <span class="text-white font-bold"><?php echo htmlspecialchars($_SESSION['user_name']); ?></span>
                </div>
                
                <a href="training/training.php" class="text-gray-900 font-bold text-sm bg-secondary hover:bg-cyan-400 transition-colors px-5 py-2 rounded-lg shadow-lg shadow-cyan-500/20 flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                    Dashboard
                </a>
                
                <a href="logout.php" class="text-white hover:text-red-400 font-medium text-sm transition-colors flex items-center gap-2 px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/10">
                    Logout
                </a>
...
<section class="relative z-30 -mt-16 mb-20">
    <div class="container mx-auto px-6">
        <div class="bg-white rounded-lg shadow-2xl border-b-4 border-primary p-8 grid grid-cols-2 md:grid-cols-3 gap-8 text-center relative overflow-hidden">
            ...
            <div class="relative">
                <div class="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-br from-orange-500 to-purple-500 mb-1">9</div>
        ...
        <div class="grid md:grid-cols-3 gap-12 text-center">
            <div class="group p-6 rounded-2xl shadow-xl border border-gray-100 hover:bg-gray-50 transition-colors duration-300">
                ...
                <p class="text-gray-500 text-sm leading-relaxed">
                    "Our mission is to empower individuals with the practical, industry-relevant skills and knowledge needed to excel in today's technology-driven world."
                </p>
            </div>
            ...
            <div class="group p-6 rounded-2xl shadow-xl border border-gray-100 hover:bg-gray-50 transition-colors duration-300">
                ...
                <p class="text-gray-500 text-sm leading-relaxed">
                    "To be a global leader in vocational education, empowering individuals with cutting-edge technological skills that drive innovation."
                </p>
            </div>
        </div>
    </div>
...
<section class="py-20 bg-white overflow-hidden" 
    ...
    x-data="{ 
        ...
        next() {
            ...
            const maxSlide = this.partners.length - this.itemsPerView;
            if (this.currentSlide < maxSlide) { this.currentSlide++; } else { this.currentSlide = 0; }
        },
        prev() {
            if(this.partners.length === 0) return;
            const maxSlide = this.partners.length - this.itemsPerView;
            if (this.currentSlide > 0) { this.currentSlide--; } else { this.currentSlide = Math.max(0, maxSlide); }
        }
    }"
...
>
    <div class="container mx-auto px-6 relative">
        <div class="text-center mb-16">
            ...
            <p class="text-gray-500 max-w-2xl mx-auto">We collaborate with top-tier companies to ensure our training meets industry standards.</p>
        ...
        <div class="flex flex-col lg:flex-row items-center gap-16">
            <div class="w-full lg:w-1/2 relative">
                <div class="relative z-10 rounded-2xl overflow-hidden shadow-2xl border-4 border-white transform hover:scale-[1.02] transition-transform duration-500">
                    <img src="assets/images/pic2.jpg" class="w-full h-auto object-cover">
                ...
                <div class="absolute -bottom-10 -right-10 w-2/3 rounded-2xl overflow-hidden shadow-2xl border-4 border-white z-20 hidden md:block transform hover:translate-y-2 transition-transform duration-500">
                    <img src="assets/images/pic1.jpg" alt="Hands-on Training" class="w-full h-auto object-cover">
                </div>
            ...
            >
                ...
                <div class="px-6 py-8 sm:px-10">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="space-y-6">
                            <div class="border-b border-gray-100 pb-4"><h5 class="text-lg font-bold text-gray-800">1. Vocational Training Programs</h5><p class="text-sm text-gray-600 mb-2">Comprehensive, hands-on training courses designed to equip students with practical skills.</p><ul class="list-disc list-inside text-sm text-gray-500 ml-2 space-y-1"><li>Information Technology (IT)</li><li>Electronics & Electrical Technology</li><li>Automotive Technology</li><li>Welding & Fabrication</li><li>Office Work & Bookkeeping</li><li>Language, Construction, Housekeeping, Beauty Care, etc.</li></ul></div>
                            <div class="border-b border-gray-100 pb-4"><h5 class="text-lg font-bold text-gray-800">2. Certification and Licensing Courses</h5><p class="text-sm text-gray-600">Short-term courses for industry-recognized certifications (e.g., TESDA RAC Technician).</p></div>
                            <div class="border-b border-gray-100 pb-4"><h5 class="text-lg font-bold text-gray-800">3. Online & E-Learning Platforms</h5><p class="text-sm text-gray-600">Virtual classrooms, self-paced modules, and online certification exams.</p></div>
                            <div class="border-b border-gray-100 pb-4"><h5 class="text-lg font-bold text-gray-800">4. Corporate Training & Workforce Development</h5><p class="text-sm text-gray-600">Customized upskilling and safety compliance training for businesses.</p></div>
                            <div class="border-b border-gray-100 pb-4"><h5 class="text-lg font-bold text-gray-800">5. Apprenticeship & Internship Programs</h5><p class="text-sm text-gray-600">Partnerships with local businesses and mentorship opportunities.</p></div>
                             <div class="pb-2"><h5 class="text-lg font-bold text-gray-800">6. Career Counseling & Placement</h5><p class="text-sm text-gray-600">Resume building, job fairs, and dedicated placement assistance.</p></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-end mb-12 border-b border-gray-200 pb-4">
            ...
            <div class="flex space-x-8">
                <button @click="activeTab = 'all'" class="pb-4 text-sm font-bold uppercase tracking-wider transition-all border-b-4" :class="activeTab === 'all' ? 'text-primary border-primary' : 'text-gray-400 border-transparent hover:text-gray-600'">All Programs</button>
                <button @click="activeTab = 'training'" class="pb-4 text-sm font-bold uppercase tracking-wider transition-all border-b-4" :class="activeTab === 'training' ? 'text-primary border-primary' : 'text-gray-400 border-transparent hover:text-gray-600'">Training</button>
                <button @click="activeTab = 'assessment'" class="pb-4 text-sm font-bold uppercase tracking-wider transition-all border-b-4" :class="activeTab === 'assessment' ? 'text-primary border-primary' : 'text-gray-400 border-transparent hover:text-gray-600'">Assessment</button>
            </div>
        </div>

        <div class="grid md:grid-cols-3 gap-8">
            <?php if ($result_courses && $result_courses->num_rows > 0): ?>
                <?php while($c = $result_courses->fetch_assoc()): ?>
                     <div 
                        x-show="activeTab === 'all' || activeTab === 'training'"
                        x-transition:enter="transition ease-out duration-300"
                        x-transition:enter-start="opacity-0 scale-95"
                        x-transition:enter-end="opacity-100 scale-100"
                        class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all group flex flex-col h-full"
                    >
                        <div class="h-56 bg-gray-200 relative">
                            <?php if(!empty($c['thumbnail'])): ?>
                                <img src="<?php echo $c['thumbnail']; ?>" alt="<?php echo $c['title']; ?>" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                            <?php else: ?>
                                <div class="w-full h-full bg-gradient-to-br from-primary to-purple-600 flex items-center justify-center text-white font-bold">No Image</div>
                            <?php endif; ?>
                             <div class="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-colors"></div> 
                            <span class="absolute top-4 right-4 bg-primary text-white px-3 py-1 rounded-full text-xs font-bold shadow-sm">Training</span>
                        </div>

                        <div class="p-6 flex-1 flex flex-col">
                            <h3 class="font-bold text-xl text-gray-800 mb-2 group-hover:text-primary transition-colors">
                                <?php echo $c['title']; ?>
                            </h3>
                            ...
                            <a href="training/training.php" class="block w-full border-2 border-primary text-primary text-center py-3 rounded-lg hover:bg-primary hover:text-white transition-colors font-bold">
                                View Details
                            </a>
                        </div>
                    </div>
                <?php endwhile; ?>
            <?php else: ?>
                <div x-show="activeTab === 'all' || activeTab === 'training'" class="col-span-3 text-center py-12 bg-white rounded-xl border-2 border-dashed border-gray-200">
                    <p class="text-gray-400 text-lg">No training courses available at the moment.</p>
                </div>
            <?php endif; ?>
        </div>
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="flex flex-col lg:flex-row gap-8 shadow-2xl rounded-3xl overflow-hidden bg-white">
            ...
            <div class="w-full lg:w-2/3 relative group bg-gray-200 min-h-[400px]">
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3859.223968254286!2d121.033621!3d14.752313!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTTCsDQ1JzA4LjMiTiAxMjHCsDAyJzAxLjAiRQ!5e0!3m2!1sen!2sph!4v1631234567890!5m2!1sen!2sph" 
                    width="100%" 
                    height="100%" 
